...
\begin{center}
    ...
    \large \ifthenelse{\boolean{publish}}{}{\vspace{2ex} \textcolor{red}{\textbf{- Beschlussempfehlung -}}}
\end{center}
...
\begin{enumerate}[(1)]
    ...
    \item Die Satzung tritt mit ihrer Veröffentlichung in der AKUT in Kraft. Diese ist unverzüglich der Fachschaft durch ortsüblichen Aushang und an geeigneter Stelle im Internet bekanntzugeben.
\end{enumerate}
\vspace{8ex}
